...
def pre_normalization(data, zaxis=[0, 1], xaxis=[8, 4]):
    ...
    for i_s, skeleton in enumerate(tqdm(s)):
        ...
        main_body_center2 = np.tile(skeleton[0][0, 1:2, :],(T,1,1)).copy()

        #print('center: ', main_body_center, main_body_center.shape)
        #print('center2: ', main_body_center2, main_body_center2.shape)
